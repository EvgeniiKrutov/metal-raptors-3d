...
| `Assets/Resources/objects/machines/` | Non-flyable machines — the background `zeppelin` (docs/zeppelins.md), and `tank_ww1` and `truck_ww1`, which serve both as battlefield wrecks (docs/battlefield.md) and as level 3's ground enemies (docs/ground-vehicles.md). | no |
