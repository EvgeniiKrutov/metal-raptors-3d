// Derived from Universal RP's Shaders/Terrain/WavingGrassBillboard.shader.
// Same passes; it only swaps in MRGrassBillboardInput.hlsl (docs/standalone-builds.md).
// Copyright (c) 2016 Unity Technologies. MIT license (see license.txt)
Shader "Hidden/MetalRaptors/BillboardWavingDoublePass"
{
    Properties
    {
