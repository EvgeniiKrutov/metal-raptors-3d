// Derived from Universal RP's Shaders/Terrain/WavingGrassInput.hlsl
// Copyright (c) 2016 Unity Technologies. MIT license (see the package's license.txt).
// Only change from the original: the distance fade in TerrainWaveGrass is computed in
// float, not half (docs/standalone-builds.md).
